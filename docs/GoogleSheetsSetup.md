...
Every task create, completion, reopen, or deletion then synchronizes the following tabs:

- `Daily Tasks`: scheduled date, task detail, creation time, completion time, and status.
